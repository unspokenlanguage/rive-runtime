...
struct GridItem {
  ...
  bool crossesFlexibleTrack(YGDimension dimension) const {
    return dimension == YGDimensionWidth ? crossesFlexibleColumn
                                         : crossesFlexibleRow;
  }
};
...
struct ResolvedAutoPlacement {
  ...
  static ResolvedAutoPlacement resolveGridItemPlacements(YGNode* node) {
